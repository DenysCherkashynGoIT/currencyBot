...
public final class Service {
    ...
    private static CurrencyBot bot;

    private Service(CurrencyBot currencyBot) {
        bot = currencyBot;
    }

    public static Service getInstance(CurrencyBot currencyBot) {
        if (Objects.isNull(service)) {
            service = new Service(currencyBot);
        }
        return service;
    }

    public String getInputData(Update update, boolean chekWithUserText) {
        Boolean readUserText = chekWithUserText && update.hasMessage() && update.getMessage().hasText();
